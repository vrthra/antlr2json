...
class AntlrG:
    ...
    def parse_objectList(self, children, typ):
        lst = []
        while children:
    ...
    def parse_grammarSpec(self, parsedtree):
        ...
        _o, children = self.parse_object(children, ANTLRv4Parser.EOF)
        self.parse_EOF(_o)
        return rules_json
